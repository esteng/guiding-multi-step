# README for "Guiding Multi-Step Rearrangement Tasks with Natural Language Instructions" 
...
## Data
Data is available [here](http://nlp.jhu.edu//robots/data/blocks_data.tar.gz) 
...
## Good Robot code and README
The interaction/manipulation/simulation code in this repo is largely taken from the [Good Robot](https://github.com/jhu-lcsr/good_robot) project. 
The README for that code is in [GR_README.md](GR_README.md).
